...
@Entity
@Table(name = "TrnPaymentEmailHistory")
public class TrnPaymentEmailHistory {
	...
	public TrnPaymentEmailHistory(int paymentTransactionID, String userType, String fromEmailID, String emailID,
